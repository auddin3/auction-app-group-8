    ...
    def test_new_superuser(self):
        ...
        with self.assertRaises(ValueError):
            db.objects.create_superuser(
                email='testuser@super.com', username='username1', first_name='first_name', password='password', is_superuser=False)
        ...
        with self.assertRaises(ValueError):
            db.objects.create_superuser(
                email='', username='username1', first_name='first_name', password='password', is_superuser=True)
